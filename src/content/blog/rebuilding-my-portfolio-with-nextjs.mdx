...
description: "A deep dive into modernizing my portfolio website using Next.js 16, TypeScript, Tailwind CSS, and Framer Motion."
date: "2025-01-09"
author: "David Braun"
...
The contact form uses Next.js API routes with Resend for email delivery, with no external form services needed.
