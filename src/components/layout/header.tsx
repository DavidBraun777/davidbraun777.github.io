...
const navItems = [
  { name: 'What I Build', href: '/#what-i-build', sectionId: 'what-i-build' },
  { name: 'Systems', href: '/#selected-systems', sectionId: 'selected-systems' },
  { name: 'How I Build', href: '/#how-i-build', sectionId: 'how-i-build' },
  {
    name: 'Principles',
    href: '/#engineering-principles',
    sectionId: 'engineering-principles',
  },
  { name: 'Current Focus', href: '/#current-interests', sectionId: 'current-interests' },
