    ...
    <section id="current-interests" className="section bg-slate-50 dark:bg-slate-900/45">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <MobileSectionDisclosure
          preview="Mostly applied AI systems, workflow automation, operational software, and infrastructure-backed products where reliability matters as much as speed."
          openLabel="See current interests"
          closeLabel="Hide current interests"
        >
