    ...
    <section id="how-i-build" className="section bg-slate-50 dark:bg-slate-900/45">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <MobileSectionDisclosure
          preview="Architecture-first workflow design, AI-assisted scaffolding, and then a refinement pass to make the system operational and reliable."
          openLabel="Read how I build"
          closeLabel="Hide build approach"
        >
