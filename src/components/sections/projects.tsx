  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      if (prefersReducedMotion) {
        // Just show cards without animation
      ...
      // Batch reveal animation for project cards
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              ...
              className="project-card group relative bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border border-slate-200 dark:border-slate-800"
            >
              {/* Image */}
