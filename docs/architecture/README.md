...
This directory will contain architecture diagrams for flagship projects.
...
<!-- TODO: David: decide which projects should get architecture diagrams first.
     ...
     - PDF Audiobook Converter (serverless architecture, S3 → Polly flow)
-->
...
Reference diagrams from project descriptions or blog posts. Example in MDX:

```mdx
![Security Lab Architecture](/docs/architecture/security-lab.svg)
```
